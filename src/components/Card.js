...
const Card = ({page, messageChange, emailChange, email, message}) => {
    ...
    return(
        ...
        (() => {
            if(page === 'home') {
                return(
                    <div className='w-50 dib br2 pa3 ma2 grow bw2 shadow-5'>
            ...
            if(page === 'projects') {
                return(
                    <div className='w-60 dib br2 pa3 ma2 grow bw2 shadow-5'>
                        <p>Test</p>
                    </div>
                )
            }
            ...
            if(page === 'contact') {
                return(
                    <div className='w-60 dib br2 pa3 ma5 grow bw2 shadow-5'>
                    <main class="pa4 black-80">
                      <form class="measure center">
                        <fieldset id="sign_up" class="ba b--transparent ph0 mh0">
                          <legend class="f4 fw6 ph0 mh0">Contact Form</legend>
                          <div class="mt3">
                            <label class="db fw6 lh-copy f6 mb2">Return email</label>
